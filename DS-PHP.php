...
function fightScreen($text){
    ...
    #################################################(                                                        .#,//&  .,        &                                            
                                                                                                                     .,.   ,,,  **                                          
                                                                                            ,.,    ,    .,,,,,  ,,,,#///#(*/**/(&#,,  ,,,,,    .,  . ,                      
                                                                                . ,.,.,,  ,,,    " . ( ($this->game->getCurrentEnemy()->getSpeed() % 2 == 0) ? ($variants[9][0]) : ($variants[9][1]) ) . "            .%(////%/,@(///(@            " . ( ($this->game->getCurrentEnemy()->getSpeed() % 2 == 0) ? ($variants[8][0]) : ($variants[8][1]) ) . "    *,,  
                                                                          .,,,.,,,                              .(/(/*#@   .(%*/(/@              " . ( ($this->game->getCurrentEnemy()->getSpeed() % 2 == 0) ? ($variants[7][0]) : ($variants[7][1]) ) . "          
                                                                   ,,,,                      " . ( ($this->game->getCurrentEnemy()->getSpeed() % 2 == 0) ? ($variants[6][0]) : ($variants[6][1]) ) . "                 *&&(##@      @(#(#(&                         
                         .@%#@@@.#,                            .,,,,," . ( ($this->game->getCurrentEnemy()->getSpeed() % 2 == 0) ? ($variants[0][0]) : ($variants[0][1]) ) . ",%(((&,      .@(((%#  " . ( ($this->game->getCurrentEnemy()->getSpeed() % 2 == 0) ? ($variants[1][0]) : ($variants[1][1]) ) . "              
                      .&&&####&&#&&%#@                         .,,,,,,                                          .&&&%##,      .%##%%&/                                      
                    .(#&#((#(##(((#######&%/                    .,,,,,," . ( ($this->game->getCurrentEnemy()->getSpeed() % 2 == 0) ? ($variants[2][0]) : ($variants[2][1]) ) . "((*#%*,         /#%**(           " . ( ($this->game->getCurrentEnemy()->getSpeed() % 2 == 0) ? ($variants[3][0]) : ($variants[3][1]) ) . "                      
                   /&%%###########%%,,,./%*,                       .,,,,,,,,,.,," . ( ($this->game->getCurrentEnemy()->getSpeed() % 2 == 0) ? ($variants[4][0]) : ($variants[4][1]) ) . "                                   ,  .,      
                   .@@%###########%,    .,                                 .,,,,,,,,,,,.,,,.,,,      " . ( ($this->game->getCurrentEnemy()->getSpeed() % 2 == 0) ? ($variants[5][0]) : ($variants[5][1]) ) . "
                   @&#########%@/%#  , @//                                         .,,,,,,,,,,,,,,,,,,,,  ,,,,.,,,,,,,,,,,,,,,,,,,,,,.,,,,  ,,,,,,,,,,,,,,,      
                   .@@%#####%%&*%@%%    .,,                                                        ,,,,,,,,,,,,,,,,(#%&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
                   .*%@&###@@%&*#@@%     ,,                                                                       /%%                                                 
                       %@@@@@@@@%%%,    *                                                                          (&.                   
